...
<h1 onClick={handleToBottom} className="bg-yellow-400 w-full text-black  text-center py-4 space-x-3 space-y-3 text-lg rounded font-extrabold hover:bg-yellow-500 hover:yellow">Car List</h1>
</div>
